...
<body>
	...
	<div class="container">
		...
		<div class="main-body">
			...
			<body>
				<form action="process" method="POST" modelAttribute="user">
					<label for="name"><b>User Name</b></label> <input type="text"
						id="name" name="user_name" class="form-field"
						placeholder="Enter User Name"> <label for="age"><b>User
							Age </b></label> <input type="text" id="age" name="user_age"
						class="form-field" placeholder="Enter User Age"> <label
						for="address"><b>User Address</b></label> <input type="text"
						id="address" name="user_address" class="form-field"
						placeholder="Enter User Address"> <label for="phone"><b>User
							Phone Number</b></label> <input type="text" id="type" name="user_phone"
						class="form-field" placeholder="Enter User Phone Number">


					<label for="email"><b>User Email</b></label> <input type="text"
